...
<div class="mx-auto max-w-7xl space-y-6 px-4 py-8 sm:px-6">
    <div><p class="text-xs font-semibold uppercase tracking-widest text-indigo-600">Platform Admin</p><h1 class="mt-1 text-2xl font-bold">Badge 監控</h1><p class="mt-1 text-sm text-gray-500">查看全站 Badge、申請與授予數；異常時可立即停用。</p></div>
