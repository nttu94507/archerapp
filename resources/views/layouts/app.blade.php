    ...
    <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between gap-4">
        ...
        <nav class="hidden md:flex items-center gap-6 text-sm font-medium">
            ...
            <a href="{{ route('profile.show') }}"
               class="px-2 py-1 rounded-lg hover:bg-gray-100 {{ request()->routeIs('profile.show') ? 'text-gray-900' : 'text-gray-600' }}">
                個人頁
            </a>
...
<aside id="mobile-drawer"
    ...
    <div class="h-full flex flex-col">
        ...
        <nav class="p-3 space-y-1 text-sm">
            ...
            <a href="{{ route('profile.show') }}"
               class="flex items-center gap-2 rounded-lg px-3 py-2 hover:bg-gray-50 {{ request()->routeIs('profile.show') ? 'font-semibold text-gray-900' : 'text-gray-700' }}">
                個人頁
            </a>
